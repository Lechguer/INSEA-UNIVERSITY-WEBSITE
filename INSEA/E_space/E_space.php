...
$sql = "SELECT * FROM etudiants_1dse WHERE id = :id";
$stmt = $db->prepare($sql);
$stmt->execute(["id" => $id]);

$user = $stmt->fetch(PDO::FETCH_ASSOC);

// Si l'utilisateur n'existe plus en base, on déconnecte
if (!$user) {
    session_destroy();
    header("Location: ../Connexion/index.php");
    exit;
...
// La table contient "nom_complet" (pas de colonne "prenom") :
// on extrait le prénom = premier mot du nom complet.
$prenom   = explode(" ", trim($user["nom_complet"]))[0];
...
<aside class="sb">
  ...
  <div class="sb-foot">
    <div class="user-row">
      <div class="ava"><?= htmlspecialchars($initiale) ?></div>
      <div>
        <div class="u-name"><?= htmlspecialchars($user["nom_complet"]) ?></div>
...
<div class="main">
  ...
  <div class="content">
    ...
    <section class="section" id="sec-cours">
      ...
      <div class="cg">
        <div class="cc">
          <div class="cc-head"><div class="cc-ico" style="background:#e6f5f0">🔢</div><div><div class="cc-name">Probabilités</div><div class="cc-teacher">👤 M. ___</div></div></div>
        ...
        <div class="cc">
          <div class="cc-head"><div class="cc-ico" style="background:#eaf0f8">⚗️</div><div><div class="cc-name">ML</div><div class="cc-teacher">👤 Mme. ___</div></div></div>
          <div class="cc-desc">Technique de réduction de dimension.</div>
          <div class="pb"><div class="pf" style="width:58%"></div></div><div class="pl">58% complété</div>
        </div>
        <div class="cc">
          <div class="cc-head"><div class="cc-ico" style="background:#fdf3e7">💻</div><div><div class="cc-name">BDR</div><div class="cc-teacher">👤 M. ___</div></div></div>
          <div class="cc-desc">Bases de données relationnelles.</div>
          <div class="pb"><div class="pf" style="width:45%"></div></div><div class="pl">45% complété</div>
        </div>
        <div class="cc">
          <div class="cc-head"><div class="cc-ico" style="background:#f5edf8">📝</div><div><div class="cc-name">Français</div><div class="cc-teacher">👤 Mme. ___</div></div></div>
    ...
    <section class="section" id="sec-notes">
      ...
      <div class="card">
        <table class="gt">
          ...
          <tr><td>Probabilités</td><td><span class="gp h">16</span></td><td style="color:var(--ink-3)">20</td><td>Contrôle n°3</td><td style="color:var(--ink-3);font-size:.77rem">05/05/2026</td></tr>
          <tr><td>TRD</td><td><span class="gp m">12</span></td><td style="color:var(--ink-3)">20</td><td>TP</td><td style="color:var(--ink-3);font-size:.77rem">28/04/2026</td></tr>
          <tr><td>Structure de données</td><td><span class="gp h">15</span></td><td style="color:var(--ink-3)">20</td><td>Devoir</td><td style="color:var(--ink-3);font-size:.77rem">22/04/2026</td></tr>
          <tr><td>Programmation Sytéme</td><td><span class="gp l">8</span></td><td style="color:var(--ink-3)">20</td><td>Projet shell</td><td style="color:var(--ink-3);font-size:.77rem">15/04/2026</td></tr>
        </table>
      </div>
    </section>
    ...
    <section class="section" id="sec-remarques">
      ...
      <div class="card">
        <div class="ri"><div class="ri-bar pos"></div><div><div class="ri-text">Excellent travail en classe, participation très active ce semestre.</div><div class="ri-meta">Par <strong>M. Skalli</strong> · 08/05/2026</div></div></div>
        <div class="ri"><div class="ri-bar neu"></div><div><div class="ri-text">Peut mieux faire en termes de rigueur dans les démonstrations.</div><div class="ri-meta">Par <strong>M Ouazza</strong> · 03/05/2026</div></div></div>
        <div class="ri"><div class="ri-bar neg"></div><div><div class="ri-text">Retard dans le rendu du dernier projet — veiller à respecter les délais.</div><div class="ri-meta">Par <strong>M. Benassila</strong> · 28/04/2026</div></div></div>
      </div>
    </section>
    ...
    <section class="section" id="sec-devoirs">
      ...
      <div class="card">
        <div class="ai"><div class="ai-left"><div class="ai-ico" style="background:rgba(226,88,112,.09)">📐</div><div><div class="ai-title">Démonstration de la loi de khi 2</div><div class="ai-course">Inférence statistique</div></div></div><span class="ad soon">Dû le 14/05/2026</span></div>
        <div class="ai"><div class="ai-left"><div class="ai-ico" style="background:rgba(58,123,213,.09)">🔭</div><div><div class="ai-title">Rapport de TP</div><div class="ai-course">Développement Web</div></div></div><span class="ad ok">Dû le 20/05/2026</span></div>
        <div class="ai"><div class="ai-left"><div class="ai-ico" style="background:rgba(31,142,120,.09)">📖</div><div><div class="ai-title">Dissertation</div><div class="ai-course">Français</div></div></div><span class="ad done">✓ Rendu</span></div>
      </div>
    </section>
